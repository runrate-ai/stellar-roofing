...
export default function CTABanner({
  ...
  const displayPhone = phone || config.business.phone;
  const dialPhone = phoneRaw || config.business.phoneRaw;
    ...
    <section className="bg-primary py-16 px-4">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          ...
          <a href={`tel:${dialPhone}`} className="flex items-center gap-2 border-2 border-white text-white hover:bg-white hover:text-primary font-semibold px-8 py-4 rounded-lg transition-colors text-lg">
            <Phone size={20} />
            {displayPhone}
          </a>
        </div>
