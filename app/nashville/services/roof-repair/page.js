...
const faqs = [
  ...
  { question: "What are common causes of roof leaks in Nashville?", answer: "Common causes include damaged or missing shingles, cracked or deteriorated flashing around chimneys and vents, clogged gutters causing water backup, damaged pipe boot collars, and storm damage from hail or wind." },
];

export default function RoofRepairNashvillePage() {
  ...
  return (
    <>
      ...
      <Breadcrumbs items={[
        ...
        { name: "Roof Repair", path: "/nashville/services/roof-repair" },
      ]} />

      <section className="relative h-72 md:h-96 flex items-center">
        <Image src="/images/service-roof-repair.jpg" alt="Roof repair in Nashville, TN" fill className="object-cover" priority />
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <div className="bg-green-50 border border-green-200 rounded-xl p-6">
              ...
              <ul className="space-y-2">
                {["Damage is isolated to a small area", "Roof is less than 15–20 years old", "Only a few shingles are damaged", "Flashing or pipe boots need sealing", "One-time storm damage on an otherwise sound roof"].map(item => (
            ...
            <div className="bg-orange-50 border border-orange-200 rounded-xl p-6">
              ...
              <ul className="space-y-2">
                {["Roof is 20+ years old", "Damage is widespread across multiple areas", "You've had repeated leaks that keep coming back", "Structural decking is compromised", "More than 30% of shingles are damaged"].map(item => (
          ...
          <h2 className="text-2xl md:text-3xl font-bold text-primary mb-4">Common Roof Problems We Fix in Nashville, TN</h2>
          ...
          <h2 className="text-2xl md:text-3xl font-bold text-primary mb-4">Repair Cost Estimates in Nashville</h2>
      ...
      <CTABanner heading="Got a Roof Leak? We Can Help." subtext="Fast, honest roof repairs in Nashville. Free estimates, no pressure." ctaText="Get Free Estimate" phone={loc.phone} phoneRaw={loc.phoneRaw} />
