...
export default function NashvilleAreaPage() {
  ...
  return (
    <>
      ...
      <Breadcrumbs items={[{ name: "Nashville", path: "/nashville" }, { name: "Service Areas", path: "/nashville#service-areas" }, { name: "Nashville", path: "/nashville/service-areas/nashville" }]} />
      ...
      <section className="relative h-64 md:h-80 flex items-center">
        ...
        <div className="relative z-10 px-4 max-w-4xl mx-auto">
          <div className="flex items-center gap-2 text-white/80 mb-2"><MapPin size={18} /><span className="font-semibold text-sm">Nashville, TN</span></div>
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-text-muted leading-relaxed mb-6">Stellar Roofing &amp; Restorations is proud to be Nashville's local roofing company. Founded in 2020 and led by owner Nate, we've built our reputation one roof at a time throughout Davidson County and the greater Nashville metro area. When you call us, you're talking to a local team that knows Nashville's weather, neighborhoods, and the roofing challenges that come with living in Middle Tennessee.</p>
          <p className="text-text-muted leading-relaxed mb-6">Nashville's climate puts roofs through a real test — hot, humid summers that accelerate shingle wear, significant storm seasons with hail and high winds, and enough winter weather to create problems with older roofing systems. All of that adds up to a city full of homes that need reliable, professional roofing care from people who actually know what they're doing.</p>
          <p className="text-text-muted leading-relaxed mb-8">Nashville has grown dramatically over the past decade. New developments in areas like East Nashville, The Nations, Germantown, and Antioch have brought new homes and new roofing needs. Older neighborhoods like Bellevue, Madison, and Donelson are home to houses with roofs that are 15–25 years old and due for replacement or repair.</p>
      ...
      <CTABanner heading="Nashville's Roofing Experts Are Ready to Help" subtext="Free inspections, honest estimates, lifetime warranty on every roof we install." phone={loc.phone} phoneRaw={loc.phoneRaw} />
