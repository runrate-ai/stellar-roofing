  ...
  return (
    <>
      ...
      <Breadcrumbs items={[
        ...
        { name: "Emergency Roof Repair", path: "/boise/services/emergency-roof-repair" },
      ]} />

      <section className="relative h-72 md:h-96 flex items-center">
        <Image src="/images/service-storm-damage.jpg" alt="Emergency roof repair in Boise, ID" fill className="object-cover" priority />
        ...
        <div className="relative z-10 px-4 max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold text-white mb-4">Emergency Roof Repair in Boise, ID</h1>
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-primary rounded-2xl p-10 text-center mb-8">
            <h2 className="text-2xl md:text-3xl font-bold text-white mb-3">Roof Emergency in Boise? Call Right Now.</h2>
      ...
      <FAQ faqs={faqs} heading="Emergency Repair FAQs — Boise, ID" />
    </>
  );
}
