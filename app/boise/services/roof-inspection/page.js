...
export const metadata = {
  title: "Free Roof Inspection Boise ID | Hail Damage Assessment | Stellar Roofing",
  description: "Free roof inspection in Boise, ID — hail damage, UV wear, winter damage, and more. No obligation, no sales pressure. Honest report with photos. Call today.",
...
const faqs = [
  ...
  { question: "What does a Boise roof inspection include?", answer: "We physically get on your roof and conduct a thorough evaluation of your shingles (including hail damage assessment), flashing, gutters, ventilation, and decking. We also check for UV degradation from Idaho's intense summer sun and any signs of winter-related damage." },
  { question: "When should I get a roof inspection in Boise?", answer: "After any hailstorm or high-wind event, if you notice water stains or dripping in your home, if your roof is 15+ years old, before buying or selling a home, or heading into winter to confirm your roof can handle snow loads." },
  { question: "What happens if you find hail damage during the inspection?", answer: "We'll show you exactly what we found — with photos — and explain your options. If the damage is insurance-claimable, we'll walk you through the claims process. There's never any pressure to commit on the spot." },
];

export default function RoofInspectionBoisePage() {
  const svcSchema = serviceSchema({
    name: "Free Roof Inspection in Boise, ID",
    description: "Free, no-obligation roof inspections in Boise, ID. We check for hail damage, UV wear, winter damage, and general roof condition.",
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <p className="text-lg text-text-muted leading-relaxed mb-8">
            Stellar Roofing &amp; Restorations offers free, no-obligation roof inspections to homeowners throughout Boise and the Treasure Valley. Our experienced team will assess the current condition of your roof — paying close attention to the specific damage patterns caused by Idaho's hailstorms, UV exposure, and winter weather — and give you a completely honest evaluation.
          </p>

          <h2 className="text-2xl md:text-3xl font-bold text-primary mb-4">What We Check in a Boise Roof Inspection</h2>
          <div className="grid md:grid-cols-2 gap-4 mb-8">
            {[
              { title: "Hail Damage", desc: "Idaho's spring hailstorms create distinctive bruising patterns on shingles. We know exactly what to look for and how to document it for insurance claims." },
              ...
              { title: "Gutters & Drainage", desc: "We check for granule buildup in gutters (a sign of shingle wear), improper slope, detachment, and damage from ice or hail." },
          ...
          <ul className="space-y-3 mb-8">
            {[
              "After any hailstorm or significant wind event in the Treasure Valley",
