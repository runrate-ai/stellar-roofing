...
export const metadata = {
  ...
  description: "Trusted roofing contractor in Nampa, ID. Roof replacement, repair, hail damage & storm damage for Canyon County homes. Free estimates, lifetime warranty. Call today.",
  alternates: { canonical: 'https://thestellarroofing.com/boise/service-areas/nampa' },
};

const faqs = [
  { question: "Do you serve Nampa and Canyon County?", answer: "Yes. We serve Nampa and Canyon County as part of our Treasure Valley service area. Our team handles roof replacements, repairs, hail damage, and insurance claims throughout the Nampa area." },
  { question: "Are Nampa homes at risk for hail damage?", answer: "Yes. Canyon County is within the Treasure Valley's hail storm path and sees similar storm risk to Ada County. Nampa homeowners should schedule a free inspection after any notable hail event." },
...
export default function NampaPage() {
  const svcSchema = serviceSchema({ name: "Roofing Services in Nampa, ID", description: "Professional roofing services in Nampa, ID and Canyon County including roof replacement, repair, and hail damage restoration.", url: "https://thestellarroofing.com/boise/service-areas/nampa", areaServed: "Nampa, ID", phone: loc.phone });
    ...
    <>
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-text-muted leading-relaxed mb-6">Canyon County sits in the same storm corridor as Ada County and sees regular hailstorms that can cause significant but often subtle damage to shingles. Nampa also experiences the Treasure Valley's characteristic temperature swings — hot, UV-intense summers that dry out and crack asphalt shingles, and cold winters with snow and freeze-thaw cycles that stress aging roofing systems.</p>
